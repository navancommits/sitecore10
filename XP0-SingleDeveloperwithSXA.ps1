...
$SCInstallRoot = "C:\sitecore\Sitecore10.0.0"
...
$XConnectSiteName = "xco10xconnect.dev.local"
# The Sitecore site instance name.
$SitecoreSiteName = "xco10sc.dev.local"
# Identity Server site name
$IdentityServerSiteName = "xco10identityserver.dev.local"
# The Path to the license file
$LicenseFile = "$SCInstallRoot\license.xml"
# The URL of the Solr Server
$SolrUrl = "https://localhost:8988/solr"
...
$singleDeveloperParams = @{
    Path = "$SCInstallRoot\XP0-SingleDeveloperwithSXA.json"
    SqlServer = $SqlServer
