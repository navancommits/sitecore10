...
# XC_IDENTITY_COMMERCEENGINECONNECTCLIENT_CLIENTSECRET1=random 64 chars
...
# REPORTING_API_KEY=random 32 chars
Set-DockerComposeEnvFileVariable "REPORTING_API_KEY" -Value (Get-SitecoreRandomString 32)
...
try {
    ...
    & $mkcert -install    
    & $mkcert -cert-file navancommcm.localhost.crt -key-file navancommcm.localhost.key "navancommcm.localhost" 
    & $mkcert -cert-file navancommid.localhost.crt -key-file navancommid.localhost.key "navancommid.localhost" 
    & $mkcert -cert-file navancommauthoring.localhost.crt -key-file navancommauthoring.localhost.key "navancommauthoring.localhost"
    & $mkcert -cert-file navancommshops.localhost.crt -key-file navancommshops.localhost.key "navancommshops.localhost"
    & $mkcert -cert-file navancommminions.localhost.crt -key-file navancommminions.localhost.key "navancommminions.localhost" 
    & $mkcert -cert-file navancommops.localhost.crt -key-file navancommops.localhost.key "navancommops.localhost" 
    & $mkcert -cert-file navancommbizfx.localhost.crt -key-file navancommbizfx.localhost.key "navancommbizfx.localhost" 
...
Add-HostsEntry "navancommcm.localhost"
Add-HostsEntry "navancommid.localhost"
Add-HostsEntry "navancommbizfx.localhost"
Add-HostsEntry "navancommauthoring.localhost"
Add-HostsEntry "navancommshops.localhost"
Add-HostsEntry "navancommops.localhost"
Add-HostsEntry "navancommminions.localhost"

Write-Host "Done!" -ForegroundColor Green

##############################################
# Create containers folder and related volumes
##############################################

Write-Host "Create containers folder..." -ForegroundColor Green

..\scripts\CreateVolumeFolders.ps1
